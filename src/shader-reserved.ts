...
export const DISPATCH_PARAMS_STRUCT_NAME = 'DispatchParamsType';
export const DISPATCH_PARAMS_BUFFER_NAME = 'DispatchParams';
...
`// reserved
struct ${DISPATCH_PARAMS_STRUCT_NAME} {
  instance_count: u32,
...
@group(3)
@binding(7)
var<uniform> ${DISPATCH_PARAMS_BUFFER_NAME}: ${DISPATCH_PARAMS_STRUCT_NAME};`;
